    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            const description = [
                ...
                `- \`/config-logs\`: Configura os canais de log para diferentes sistemas. ***IMPORTANTE:*** Configure os canais de log para garantir que todas as ações e eventos sejam registrados corretamente. O canal de AutoMod é especialmente importante para monitorar as ações automáticas do bot.`,
                ...
                `### ${emojis.History || '⚙️'} Ajuda com BOT`,
                `- \`/botstatus\`: Informa o status atual do bot e seus sistemas`,
                `### ${emojis.chat || '💬'} Ajuda com BOT`,
