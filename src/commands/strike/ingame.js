        ...
        try {
            ...
            if (!link) {
                return await ResponseManager.error(
                    interaction,
                    'Nenhuma conta Discord vinculada a este Alderon ID. Use /strike registro (se o jogador estiver no servidor), /strike personalizado, ou peça para o jogador rodar /registrar primeiro.',
                );
            }
